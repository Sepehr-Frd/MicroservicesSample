...
namespace ToDoListManager.DataAccess.Migrations
{
    ...
    partial class ToDoListManagerContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.AnswerVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.Bookmark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.Profile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.Question", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.QuestionVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.Answer", b =>
                {
                    b.HasOne("ToDoListManager.Model.Entities.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.AnswerVote", b =>
                {
                    b.HasOne("ToDoListManager.Model.Entities.Answer", "Answer")
                        .WithMany("Votes")
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.Profile", b =>
                {
                    b.HasOne("ToDoListManager.Model.Entities.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("ToDoListManager.Model.Entities.Profile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ToDoListManager.Model.Entities.UserRole", b =>
                {
                    b.HasOne("ToDoListManager.Model.Entities.Role", "Role")
                        .WithMany("UserRoles")
